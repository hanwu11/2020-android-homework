package com.example.myfirstappshop.adapter;
...
import com.example.myfirstappshop.bean.GoInfo;
import com.example.myfirstappshop.widget.RecyclerExtras.OnItemClickListener;
import com.example.myfirstappshop.widget.RecyclerExtras.OnItemLongClickListener;
...
public class RecyclerStaggeredAdapter extends RecyclerView.Adapter<ViewHolder> implements OnItemClickListener, OnItemLongClickListener{
    ...
    private ArrayList<GoInfo> mGoArray;

    public RecyclerStaggeredAdapter(Context context, ArrayList<GoInfo> goodsArray) {
        mContext = context;
        mGoArray = goodsArray;
    }
    ...
    public void onBindViewHolder(ViewHolder vh, final int position) {
        ...
        holder.iv_pic.setImageResource(mGoArray.get(position).pic_id);
        holder.tv_title.setText(mGoArray.get(position).title);
